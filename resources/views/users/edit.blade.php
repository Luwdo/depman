...
@section('content')
    <div class="content container">
        <h5>Edit User</h5>
        <hr />
        <form method="POST" action="{{ route('edit_user_post', ['id'=>$user->id]) }}">
            @csrf
            ...
            <div class="form-group row mb-0">
                <div class="col-md-6 offset-md-4">
                    ...
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-user">Delete</button>
                </div>
            </div>
        </form>
        ...
        <div class="modal fade" id="delete-user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{ route('delete_user_post', ['id'=>$user->id]) }}">
                        @csrf
